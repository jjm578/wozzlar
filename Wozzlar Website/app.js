    ...
    _tgInstance = new tourguide.TourGuideClient({
      steps: [
        ...
        },
        {
          target: "#phrase",
          title: "Step 1",
          content: "Here's your mystery phrase. <strong>Two words</strong> to discover!",
        },
        {
          target: "#phrase",
          title: "Step 2",
        ...
        },
        {
          target: "#kb",
          title: "Step 7",
          content: "Check the keyboard! Keys you used now have colors matching what you learned.",
        },
        {
          target: "#kb",
          title: "Step 8",
        ...
        },
        {
          target: "#phrase",
          title: "Step 9",
          content: "All pink! ✨ You solved it. Game moves to next word automatically.",
        },
        {
          target: "#phrase",
          title: "Step 10",
        ...
        },
        {
          target: "#phrase",
          title: "Done! ✨",
          content: "You solved the mystery phrase! That's how you play.",
        },
        {
          target: ".nav-left",
          title: "Badges",
          content: "Daily: 7 guesses. Win → 🏆 Wozzlar. Lose → 😐 Womp.",
        },
        {
          target: "#btnSolve",
          title: "ALL IN",
          content: "Type whole phrase at once. Risky but rewarding!",
        },
        {
          target: "#btnPractice",
          title: "Practice",
          content: "Unlimited puzzles. No pressure, just fun!",
        },
        {
          title: "Ready! 🚀",
          content: "Go solve today's puzzle!",
        },
      ],
      debug: false,
